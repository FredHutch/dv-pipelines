...
gex_fastq_files_v2 = Channel.fromPath(source_path + wfi.parameters.input.gex_fastq_path)
...
process TENX_COUNT {
  ...
  script:
    ...
    COMMAND="cellranger count --id=$sample.library_id --transcriptome=$gex_ref"
...
process TENX_VDJ {
  ...
  script:
    ...
    COMMAND="\$COMMAND --fastqs=fastq/ $samplecmd" 
